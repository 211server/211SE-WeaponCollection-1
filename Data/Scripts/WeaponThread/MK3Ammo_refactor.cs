...
{ // Don't edit above this line
    partial class Weapons
    {
        ...
        private AmmoDef APShell406mmAmmo => new AmmoDef
        {
            AmmoMagazine = "APShell406mm",
            AmmoRound = "APShell406mmAmmo",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.000000001f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 25000f,
            Mass = 100f, // in kilograms
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        ApplyToShield = true,
                        ShrinkByDistance = false,
                        Color = Color(red: 5, green: 7, blue: 6, alpha: 1),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f,
                        Width = 0.3f,
                        Color = Color(red: 4, green: 10, blue: 3, alpha: 1),
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
                        Material = "WeaponLaser",
                        DecayTime = 6,
                        Color = Color(red: 2, green: 5, blue: 2, alpha: 1),
                        Back = false,
                        CustomWidth = 0.3f,
                        UseWidthVariance = false,
                        UseColorFade = true,
